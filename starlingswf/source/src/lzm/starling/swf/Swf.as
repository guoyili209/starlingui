...
//			}
		...
		public function createTextField(name:String,data:Array=null):TextField{
			...
			if(data != null){
				...
				textfield.format.font = data[12];
				textfield.format.color = data[13];
				textfield.format.size = data[14];
				textfield.format.horizontalAlign = data[15];
				textfield.format.italic = data[16];
				textfield.format.bold = data[17];
