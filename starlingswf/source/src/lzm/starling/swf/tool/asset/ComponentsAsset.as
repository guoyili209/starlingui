package lzm.starling.swf.tool.asset
{
   ...
   public class ComponentsAsset
   {
      ...
      private function loadComponentSwf(componentUrls:Array) : void
      {
         ...
         var ioError:Function = function(param1:Event):void
         {
            urlLoader.removeEventListener("complete",loadSwfComplete);
            urlLoader.removeEventListener("ioError",ioError);
            loadComponentSwf(componentUrls);
         };
         var loadBytes:Function = function(param1:ByteArray):void
         {
         ...
         var loadBytesComplete:Function = function(param1:Event):void
         {
            var _loc2_:* = null;
            var _loc4_:* = null;
            var _loc5_:* = null;
