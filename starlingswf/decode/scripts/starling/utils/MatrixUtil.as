package starling.utils
{
   ...
   public class MatrixUtil
   {
      ...
      public static function transformCoords3D(param1:Matrix3D, param2:Number, param3:Number, param4:Number, param5:Vector3D = null) : Vector3D
      {
         ...
         var _loc6_:Vector.<Number> = param1.rawData;
         param5.x = param2 * _loc6_[0] + param3 * _loc6_[4] + param4 * _loc6_[8] + _loc6_[12];
         param5.y = param2 * _loc6_[1] + param3 * _loc6_[5] + param4 * _loc6_[9] + _loc6_[13];
         param5.z = param2 * _loc6_[2] + param3 * _loc6_[6] + param4 * _loc6_[10] + _loc6_[14];
         param5.w = param2 * _loc6_[3] + param3 * _loc6_[7] + param4 * _loc6_[11] + _loc6_[15];
         return param5;
      }
