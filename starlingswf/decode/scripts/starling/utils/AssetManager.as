package starling.utils
{
   ...
   public class AssetManager extends EventDispatcher
   {
      ...
      private var _runtimeLoadTexture:Dictionary;
      ...
      protected function getName(param1:Object) : String
      {
         ...
         {
            _loc2_ = param1 is String?param1 as String:(param1 as FileReference).name;
      ...
      public function loadTexture(param1:String, param2:Function, param3:Boolean = true) : void
      {
         ...
         completeAssets = function(param1:Object):void
         {
            ...
            if(isCache)
            {
               _runtimeLoadTexture[name] = texture;
            }
         };
         ...
         var texture:Texture = _runtimeLoadTexture[name];
         if(texture)
         {
            if(callBack != null)
            {
      ...
      public function clearRuntimeLoadTexture() : void
      {
         ...
         {
            var _loc3_:int = 0;
            var _loc2_:* = _runtimeLoadTexture;
            for each(var _loc1_ in _runtimeLoadTexture)
            {
               _loc1_.dispose();
            }
            _runtimeLoadTexture = new Dictionary();
