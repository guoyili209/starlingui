package starling.display
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function addQuickChild(param1:DisplayObject) : void
      {
         if(param1.mParent)
         {
      ...
      public function addQuickChildAt(param1:DisplayObject, param2:int) : DisplayObject
      {
      ...
      public function removeQuickChild(param1:DisplayObject) : void
      {
