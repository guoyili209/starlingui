            ...
            while(_loc19_ <= _loc5_)
            {
               ...
               while(_loc24_ < _loc12_)
               {
                  ...
                  if(!(_loc7_ == null || _loc7_ == "comp"))
                  {
                     ...
                     _loc3_ = [_loc17_,_loc7_,_loc10_.x * Util.swfScale,_loc10_.y * Util.swfScale,_loc10_.scaleX,_loc10_.scaleY,_loc10_.transform.matrix == null?0:Number(MatrixUtil.getSkewX(_loc10_.transform.matrix)),_loc10_.transform.matrix == null?0:Number(MatrixUtil.getSkewY(_loc10_.transform.matrix)),_loc10_.alpha];
