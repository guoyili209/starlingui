package lzm.starling.swf.tool.utils
{
   ...
   public class ExportUtil
   {
      ...
      public static const platform_egret:String = "Egret";
      ...
      public function exportFiles(param1:Array, param2:Number, param3:Boolean, param4:Boolean, param5:Number, param6:String, param7:Number, param8:Number, param9:String, param10:Function, param11:Boolean) : void
      {
         _exportFiles = param1;
         _exportScale = param2;
         _isMerger = param3;
         _isMergerBigImage = param4;
         _isAnySize = param11;
         _padding = param5;
         _exportPath = param6;
         _bigImageWidth = param7;
         _bigImageHeight = param8;
         _exportPlatform = param9;
         _callBack = param10;
      ...
      private function loadSwf(param1:File) : void
      {
         ...
         else
         {
            ...
            Assets.openTempFile(file.url,function():void
            {
               ...
               getBitmapDatas = function(param1:Array):void
               {
                  var _loc2_:* = null;
                  var _loc6_:int = 0;
                  var _loc3_:Array = [];
