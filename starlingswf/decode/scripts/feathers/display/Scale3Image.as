   ...
   public class Scale3Image extends Sprite implements IValidating
   {
      ...
      public function validate() : void
      {
         ...
         if(this._propertiesChanged || this._layoutChanged || this._renderingChanged)
         {
            ...
            {
               _loc6_ = this._width;
               _loc8_ = _loc6_ / this._frame.width;
               _loc5_ = this._textures.firstRegionSize * _loc8_;
               _loc2_ = (this._frame.height - this._textures.firstRegionSize - this._textures.secondRegionSize) * _loc8_;
               _loc7_ = _loc5_ + _loc2_;
               _loc7_ = _loc5_ + _loc2_;
               if(_loc7_ > this._width)
               {
                  _loc3_ = this._width / _loc7_;
                  _loc5_ = _loc5_ * _loc3_;
                  _loc2_ = _loc2_ * _loc3_;
                  _loc7_ = _loc5_ + _loc2_;
               }
               _loc1_ = this._height - _loc7_;
               if(_loc6_ > 0)
               {
                  if(_loc5_ > 0)
                  {
                  ...
                  if(_loc2_ > 0)
                  {
                     ...
                     helperImage.readjustSize();
                     helperImage.x = 0;
                     helperImage.y = this._height - _loc2_;
                     helperImage.width = _loc6_;
            ...
            {
               _loc6_ = this._height;
               _loc8_ = _loc6_ / this._frame.height;
               _loc5_ = this._textures.firstRegionSize * _loc8_;
               _loc2_ = (this._frame.width - this._textures.firstRegionSize - this._textures.secondRegionSize) * _loc8_;
               _loc7_ = _loc5_ + _loc2_;
               _loc7_ = _loc5_ + _loc2_;
               if(_loc7_ > this._width)
               {
               ...
               if(_loc6_ > 0)
               {
                  ...
                  if(_loc2_ > 0)
                  {
                     helperImage.texture = this._textures.third;
                     helperImage.readjustSize();
                     helperImage.x = this._width - _loc2_;
                     helperImage.y = 0;
