      ...
      public function validate() : void
      {
         ...
         if(this._propertiesChanged || this._layoutChanged)
         {
            ...
            while(_loc9_ < _loc4_)
            {
               ...
               _loc13_ = _loc14_ >= this._width?this._width - _loc11_:Number(_loc3_);
               _loc1_ = _loc7_ >= this._height?this._height - _loc8_:Number(_loc10_);
