package feathers.controls
{
   ...
   public class Button extends FeathersControl implements IFocusDisplayObject
   {
      ...
      override protected function draw() : void
      {
         ...
         if(_loc1_ || _loc6_ || _loc5_ || _loc4_ || _loc2_)
         {
            this.layoutContent();
         }
         if(_loc2_ || _loc3_)
         ...
         if(_loc2_)
         {
            if(this.currentIcon && this.label)
            {
               if(this._iconPosition != "top" && this._iconPosition != "bottom" && this._iconPosition != "manual")
               {
                  ...
                  _loc3_ = Number(this.currentIcon.width + _loc4_ + HELPER_POINT.x);
               }
               else
               {
                  _loc3_ = Number(Math.max(this.currentIcon.width,HELPER_POINT.x));
               }
            }
            else if(this.currentIcon)
            {
               _loc3_ = Number(this.currentIcon.width);
            }
            else if(this.label)
            {
            ...
            if(_loc3_ !== _loc3_)
            {
               _loc3_ = Number(this._originalSkinWidth);
               if(_loc3_ != _loc3_)
               {
                  _loc3_ = 0;
               }
            ...
            {
               if(this._originalSkinWidth > _loc3_)
               {
                  _loc3_ = Number(this._originalSkinWidth);
               }
            }
         ...
         if(_loc5_)
         {
            if(this.currentIcon && this.label)
            {
               if(this._iconPosition == "top" || this._iconPosition == "bottom")
               {
                  ...
                  _loc1_ = Number(this.currentIcon.height + _loc4_ + HELPER_POINT.y);
               }
               else
               {
                  _loc1_ = Number(Math.max(this.currentIcon.height,HELPER_POINT.y));
               }
            }
            else if(this.currentIcon)
            {
               _loc1_ = Number(this.currentIcon.height);
            }
            else if(this.label)
            {
               _loc1_ = Number(HELPER_POINT.y);
            }
            _loc1_ = Number(_loc1_ + (this._paddingTop + this._paddingBottom));
            if(_loc1_ != _loc1_)
            {
               _loc1_ = Number(this._originalSkinHeight);
               if(_loc1_ != _loc1_)
               {
                  _loc1_ = 0;
               }
